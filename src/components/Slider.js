		...
		<div className="relative">
			...
			<div className="relative group mt-1.5">
				<input
					...
					className="w-full px-3 py-1.5 rounded border border-pink-400/30 
                   bg-pink-950/30 backdrop-blur-sm text-pink-100 text-center
			...
			<div className="relative w-full group mt-1">
				<div className="absolute w-full h-0.5 bg-pink-950/50 rounded-full overflow-hidden top-1/2 -translate-y-1/2">
					<div
