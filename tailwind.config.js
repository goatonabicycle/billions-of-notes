	...
	theme: {
		extend: {
			...
			boxShadow: {
				...
				'glow-title': '0px 0px 120px rgba(59, 130, 246, 0.5), inset 0 0 10px rgba(59, 130, 246, 0.5)',
			},
			keyframes: {
				slide: {
					'100%': {
				...
				'pulse-glow': {
					'0%, 100%': {
						'box-shadow': '0 0 20px rgba(59, 130, 246, 0.8), 0 0 40px rgba(59, 130, 246, 0.4), inset 0 0 15px rgba(59, 130, 246, 0.2)',
						'transform': 'scale(1)',
					},
					'50%': {
						'box-shadow': '0 0 30px rgba(59, 130, 246, 1), 0 0 60px rgba(59, 130, 246, 0.6), inset 0 0 20px rgba(59, 130, 246, 0.3)',
